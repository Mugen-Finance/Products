...
contract AvaxSwapsTest is Test {
    ...
    function setUp() public {
        ...
        avaxSwaps = new AvaxSwaps(IWETH9(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7), 
    ...
    function testLB() public {
        ...
        assertEq(address(avaxSwaps).balance, 0);
        assertGt(IERC20(0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E).balanceOf(address(this)), 180e6);
    }
}
