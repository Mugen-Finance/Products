...
contract SwapsTest is Test {
    ...
    //     }
    function testVelo(uint256 x) public {
        vm.assume(x > 1e18 && x < 100e18);
        ...
        swaps.swaps{value: x + 1e18}(steps, data);
        ...
        assertGt(
            ...
            0
        ); //Needs to be greater than zero to show the proper fee mechanism
    }
