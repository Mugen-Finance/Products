...
//         //Pull in tokens
//         if (_amountEth > 0)
//             Constants.weth.transferFrom(msg.sender, vaultTreasury, _amountEth);
//         if (_amountUsdc > 0)
//             Constants.usdc.transferFrom(msg.sender, vaultTreasury, _amountUsdc);
//         if (_amountOsqth > 0)
//             Constants.osqth.transferFrom(
//                 msg.sender,
//                 vaultTreasury,
//                 _amountOsqth
//             );
...
//         IVaultStorage(vaultStorage).setDepositCount(
//             IVaultStorage(vaultStorage).depositCount() + 1
//         );
...
//             );
//             uint256 amountEth1;
//             (amountEth1, amountOsqth) = IVaultMath(vaultMath)
//                 .burnLiquidityShare(
...
//             uint256 bETH = (
//                 _getBalance(Constants.weth).sub(
//                     IVaultStorage(vaultStorage).accruedFeesEth()
//                 )
//             ).mul(ratio);
//             uint256 bUSDC = (
//                 _getBalance(Constants.usdc).sub(
//                     IVaultStorage(vaultStorage).accruedFeesUsdc()
//                 )
//             ).mul(ratio);
//             uint256 bOSQTH = (
//                 _getBalance(Constants.osqth).sub(
...
//         IVaultStorage(vaultStorage).updateAccruedFees(
//             amountEth,
//             amountUsdc,
//             amountOsqth
//         );
...
//     {
//         //Get current prices
//         (uint256 ethUsdcPrice, uint256 osqthEthPrice) = IVaultMath(vaultMath)
//             .getPrices();
//         uint256 depositorValue = _isFlash
//             ? _amountEth
//             : IVaultMath(vaultMath).getValue(
//                 _amountEth,
//                 _amountUsdc,
//                 _amountOsqth,
//                 ethUsdcPrice,
...
//             usdcToDeposit = depositorValue.mul(25e16).mul(ethUsdcPrice).div(
//                 uint256(1e30)
//             );
...
//                 uint256 usdcAmount,
//                 uint256 osqthAmount
//             ) = IVaultMath(vaultMath).getTotalAmounts();
