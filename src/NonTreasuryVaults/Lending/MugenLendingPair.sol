...
import {IMugenLendingWhitelist} from "./interfaces/IMugenLendingWhitelist.sol";
import {IRateCalculator} from "./interfaces/IRateCalculator.sol";
import {ISwapper} from "./interfaces/ISwapper.sol";
import "./MugenLendingCore.sol";

contract MugenLendingPair is IERC20Metadata, MugenLendingCore {
        ...
        returns (string memory)
    {
        ...
        return string(abi.encodePacked("MugenLendingV1 - ", collateralContract.safeSymbol(), "/", assetContract.safeSymbol()));
    }
    ...
    function getImmutableAddressBool()
        ...
        returns (
            ...
            address _MugenLending_WHITELIST,
        ...
        )
    {
        ...
        _MugenLending_WHITELIST = FRAXLEND_WHITELIST_ADDRESS;
